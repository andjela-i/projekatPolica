...
namespace Polica.Migrations
{
    ...
    [Migration("20220116202659_cetvrta")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Models.Knjiga", b =>
                {
                    ...
                    b.HasIndex("PolicaaID");

                    b.ToTable("Knjiga");
                });

            modelBuilder.Entity("Models.Policaa", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Models.Knjiga", b =>
                {
                    b.HasOne("Models.Policaa", null)
                        .WithMany("Knjige")
                        .HasForeignKey("PolicaaID");
                });
